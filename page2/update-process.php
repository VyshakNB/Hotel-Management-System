...
if(count($_POST)>0) {
mysqli_query($conn,"UPDATE book_now set name='" . $_POST['name'] . "', email='" . $_POST['email'] . "', phone='" . $_POST['phone'] . "', room='" . $_POST['room'] . "' ,message='" . $_POST['message'] . "', ci='" . $_POST['ci'] . "', co='" . $_POST['co'] . "' WHERE email='" . $_POST['email'] . "'");
$message = "Record Modified Successfully";
}
$result = mysqli_query($conn,"SELECT * FROM book_now WHERE email='" . $_GET['email'] . "'");
...
<br>
Check in :<br>
<input type="date" name="ci" class="txtField" value="<?php echo $row['ci']; ?>">
<br>
check out: <br>
<input type="date" name="co" class="txtField" value="<?php echo $row['co']; ?>">
<br>
